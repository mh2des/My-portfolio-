                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 auto-rows-[minmax(180px,auto)]">
                        ...
                        >
                            ...
                            <div className="flex gap-4 mt-8">
                                <a href="/cv/Mansoor_Software_CV.pdf" download className="inline-flex items-center gap-2 px-5 py-2.5 bg-foreground/10 text-foreground hover:bg-foreground hover:text-white rounded-full transition-all duration-300 font-medium text-sm">
                                    <Download size={16} />
                                    Download CV
                                </a>
                                <div className="flex gap-2">
                                    <a href="https://github.com/mh2des" target="_blank" className="p-2.5 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors text-muted-foreground hover:text-foreground">
                                        <Github size={20} />
                                    </a>
                                    <a href="https://linkedin.com/in/mansoor-shokla-1a9781353" target="_blank" className="p-2.5 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors text-muted-foreground hover:text-foreground">
                                        <Linkedin size={20} />
                                    </a>
                                </div>
                            </div>
                        ...
                        >
                            ...
                            <div className="flex flex-wrap gap-2">
                                {["Data Science", "Mobile App Development", "NLP", "Machine Learning", "TensorFlow", "Flutter", "Python", "React", "Next.js"].map((tech) => (
                                    <span key={tech} className="px-3 py-1.5 rounded-lg bg-gray-100 border border-gray-200/60 text-sm font-medium text-foreground/80">
                                        {tech}
                                    </span>
                                ))}
                            </div>
                        ...
                        <motion.div
                            ...
                            className="md:col-span-2 lg:col-span-1 liquid-glass rounded-3xl p-6 flex flex-col justify-between hover:border-gray-300 transition-colors"
                        >
                            ...
                            <div>
                                ...
                                <p className="text-xs text-foreground/70 mt-1">CGPA 3.65 • Dean&apos;s List</p>
                            </div>
                        </motion.div>
